...
const APP_NAME = 'Home Service Provider';
const DEFAULT_LANGUAGE = 'en';

const primaryColor = Color(0xFF5F60B9);

const DOMAIN_URL =
    'https://homeserviceforthai.com'; // Don't add slash at the end of the url
...
const PURCHASE_URL = 'https://homeserviceforthai.com';

const GOOGLE_MAPS_API_KEY = 'AIzaSyCSGS7jsg4UAAVhkCZO6bi57yr102ijylk';
