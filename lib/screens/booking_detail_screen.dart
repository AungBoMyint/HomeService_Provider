...
class BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  void _handlePendingApproval(
      ...
      bool isAddExtraCharges = false}) async {
    appStore.setLoading(true);
    ...
    Map req = {
      ...
      BookingUpdateKeys.durationDiff: timeInterval,
      BookingUpdateKeys.paymentStatus: val.bookingDetail!.isAdvancePaymentDone
          ? SERVICE_PAYMENT_STATUS_ADVANCE_PAID
              ...
              AnimatedScrollView(
                ...
                children: [
                  ...
                  if (res.data!.bookingDetail != null &&
                      res.data!.bookingDetail!.type != SERVICE_TYPE_FREE)
                    PriceCommonWidget(
                      bookingDetail: res.data!.bookingDetail!,
                      serviceDetail: res.data!.service!,
                        ...
                        builder: (_) {
                          return DraggableScrollableSheet(
                            ...
                            builder: (context, scrollController) =>
                              ...
                              data:
                                  snap.data!.bookingActivity!.reversed.toList(),
