...
import 'components/translate_dropdown.dart';
...
class _UserChatScreenState extends State<UserChatScreen>
  ...
  void init() async {
    ...
    log("ReceiverUser : ${widget.receiverUser.toJson()}");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
        ...
        titleWidget: Text(widget.receiverUser.firstName.validate(),
            ...
            Container(
              ...
              child: FirestorePagination(
                ...
                itemBuilder: (context, snap, index) {
                  ...
                  final fromLanguage = data.isMe! ? language2 : language1;
                  final toLanguage = data.isMe! ? language1 : language2;
